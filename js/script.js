...
(() => {
  ...
  const AR_EN = {
    ...
    'يوميًا من ٩ صباحًا حتى ٤ صباحًا':'Daily from 9:00 AM to 4:00 AM',
    '٩ ص – ٤ ص':'9:00 AM – 4:00 AM',
    'مفتوح ٢٤ ساعة':'Open 24 Hours',
    'مفتوح 24 ساعة':'Open 24 Hours',

    '© 2026 ريڤو كوفي — جميع الحقوق محفوظة':'© 2026 Revo Coffee — All Rights Reserved',
    'ريڤو':'Revo','ريڤو كوفي':'Revo Coffee','شعار ريڤو كوفي':'Revo Coffee logo','انستجرام':'Instagram','فيسبوك':'Facebook','تيك توك':'TikTok','واتساب':'WhatsApp',
    'ريڤو كوفي | REVO Coffee':'Revo Coffee | REVO Coffee',
    'المنيو | ريڤو كوفي':'Menu | Revo Coffee',
    'عن الكافيه | ريڤو كوفي':'About Us | Revo Coffee',
    'تواصل معنا | ريڤو كوفي':'Contact Us | Revo Coffee',
    'منتجاتنا | ريڤو كوفي':'Products | Revo Coffee',
    'بريك من الصداع — قهوة بتتحضر طازة وبعناية، عشان يومك يبدأ صح.':'A Break From The Headache — Freshly prepared coffee made with care for your better day.',
    '١٥':'15','٢٠':'20','٢٠٢٦':'2026','٢٥':'25','٣٠':'30','٣٥':'35','٤٠':'40','٤٥':'45','٥٠':'50','٦٠':'60','٦٥':'65','٧٠':'70','٧٥':'75',
    '٢٥ ج.م':'25 EGP','٥٠ ج.م':'50 EGP','٦٠ ج.م':'60 EGP','٧٠ ج.م':'70 EGP',
    'ريڤو كوفي - بريك من الصداع. مشروبات ساخنة، اسبريسو، سموزي، ميلك شيك وايس كوفي.':'Revo Coffee - A break from the headache. Hot drinks, espresso, smoothies, milkshakes, and iced coffee.',
  ...
  function translateAttributes(dictionary) {
    document.querySelectorAll('[placeholder],[title],[aria-label],[alt],[content]').forEach(el => {
  ...
  function applyLanguage(lang) {
    ...
    translateTextNodes(document.documentElement, isEnglish ? AR_EN : EN_AR);
